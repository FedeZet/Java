...
public class SaludYFitness {
    public static void main(String[] args) {
        ...
        // Constantes
        final var META_PASOS_DIARIOS = 1000;
        final var CALORIAS_POR_PASO = 0.04; // Valor aproximado en kilocalorías
        ...
        var metaAlcanzada = (pasosDiarios >= META_PASOS_DIARIOS) ? "Si :D" : "No D:";
